...
const Navbar = ({ user, isSidebarOpen, setIsSidebarOpen }) => {
  ...
  if (userRole === 'admin') {
    ...
    username = localStorage.getItem('superadmin_name')
  }
      ...
      <Toolbar sx={{ justifyContent: 'space-between' }}>
        ...
        <FlexBetween>
          ...
          <Typography variant='h6' align='center' sx={{ color: '#000000' }}>
            Arab Advanced Industrial Company
          </Typography>
          {/* <FlexBetween
        ...
        <FlexBetween gap='1.5rem'>
          ...
          <FlexBetween>
            <Typography variant='h4' align='center' sx={{ color: '#000000', marginRight: '10px' }}>
              الشركة العربية المتقدمة لصناعة
            </Typography>
            <Button
              onClick={handleClick}
              sx={{
